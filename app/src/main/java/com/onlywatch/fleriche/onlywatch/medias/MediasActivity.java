 ...
 */
@TargetApi(13)
public final class MediasActivity extends Activity implements OnFullscreenListener {
    ...
    public static final class video_list_fragment extends ListFragment {
        ...
        static {
            ...
            list.add(new VideoEntry("Overwatch Trailer", "FqnKB22pOC0"));
            list.add(new VideoEntry("Overwatch Animated Short | “Dragons”", "oJ09xdxzIJQ"));
            list.add(new VideoEntry("Overwatch Animated Short | “Hero”", "cPRRupAM4DI"));
            list.add(new VideoEntry("Overwatch Animated Short | “Recall”", "sB5zlHMsM7k"));
            list.add(new VideoEntry("Overwatch Animated Short | “Alive”", "U130wnpi-C0"));
            list.add(new VideoEntry("Overwatch Animated Short | “Infiltration”", "Og5-Pm4HNlI"));
            list.add(new VideoEntry("Overwatch Animated Short | “The Last Bastion”", "to8yh83jlXg"));
    ...
    public static final class video_fragment extends YouTubePlayerFragment
        ...
        public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean restored) {
            ...
            player.setOnFullscreenListener((MediasActivity) getActivity());
