...
public class HeroesFilterActivity extends AppCompatActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mHeroFilter != null)
            mHeroFilter.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    private void initView() {
        ...
        mHeroFilter = (Button) findViewById(R.id.btnHeroFilter);
